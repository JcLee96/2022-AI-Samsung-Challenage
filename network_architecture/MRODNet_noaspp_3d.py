...
from network_architecture.efficientnet_pytorch.model_3d import EfficientNet
...
class EfficientnetBackboneDrnnSddLossNoAspp(nn.Module):
    ...
    def __init__(self, n_channels, growth_rate, reduction, k_ordinal_class, dev_0, dev_1, dev_2, dev_3, model_name, scale_factor=(1, 14, 14)):
        ...
        n_channels = int(n_channels * reduction) # n_channesl =
        # # resblock
...
if __name__ == '__main__':
    input = torch.rand(1, 60, 19, 224, 224)
    net = EfficientnetBackboneDrnnSddLossNoAspp(60, 12, 0.5, 99, dev_0=torch.device("cpu"), dev_1=torch.device("cpu"), dev_2=torch.device("cpu"), dev_3=torch.device("cpu"), model_name="efficientnet-b0")
